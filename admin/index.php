...
<body>
    ...
    <main class="main">
            ...
            <?php if (!empty($menus)): ?>
                <?php foreach ($menus as $menu): ?>
                    <tr>
                        ...
                        <td><a href="edit_top_menu.php?id=<?= $menu['id']; ?>">Edit</a></td>
                        <td><a href="delete_top_menu.php?id=<?= $menu['id']; ?>">Hapus</a></td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
        ...
        <div class="add-menu">
            <a href="add_top_menu.php" class="btn-add">+ Tambah Menu</a>
        </div>
    </main>
    <footer class="footer">
