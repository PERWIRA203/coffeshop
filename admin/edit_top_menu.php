...
$id = $_GET['id'];
$sql = "SELECT * FROM topmenu WHERE id = ?";
...
<body>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form method="POST" enctype="multipart/form-data" action="update_top_menu.php">
                <input type="hidden" name="id" value="<?= $menu['id']; ?>">
                <div class="mb-3">
                    <label class="form-label"><h3>Nama</h3></label>
                    <input type="text" name="nama" class="form-control" value="<?= htmlspecialchars($menu['nama']); ?>" required>
                </div>
                <div class="mb-3">
                    <label class="form-label"><h3>Deskripsi</h3></label>
                    <textarea name="deskripsi" class="form-control" rows="3" required><?= htmlspecialchars($menu['deskripsi']); ?></textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <img src="../image/<?= htmlspecialchars($menu['gambar']); ?>" width="100" height="100" class="rounded mb-2">
